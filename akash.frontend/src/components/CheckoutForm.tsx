...
const CheckoutForm = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-20">
      <h2 className="text-4xl font-bold text-gray-800">Checkout</h2>
      <div className="bg-white rounded-lg shadow-md p-8 mt-6 w-[40vw]">
        <form onSubmit={handleDeposit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out"
          >
            Deposit Now
          </button>
        </form>
